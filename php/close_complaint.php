...
<style>
    ...
    <div class="content">
            ...
            <label for="action"style="color:white">Select Action:</label>
            ...
            <div id="otpContainer" style="display: none;" class="otp">
                <label for="otp" style="color:white">Upload Complaint Completion Image</label>
                <input type="file" id="otp" name="file" required style="color:white">
