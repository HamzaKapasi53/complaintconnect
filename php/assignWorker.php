                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="bottom">
                            ...
                            <div>
                                <img src="../images/icons8-history-90 1.svg" alt="">
                                <h2>Last Update : </h2>
                                <h2><?php echo ($row["last_updation"]) ? date("d-m-Y", strtotime($row["last_updation"])) : "No Status"; ?>
                                </h2>
                            </div>
                            <div>
                                <img src="../images/icons8-tick-96 1.svg" alt="">
                                <h2>Resolved Date : </h2>
                                <h2> <?php echo ($row["resolved_time"]) ? date("d-m-Y", strtotime($row["resolved_time"])) : "No Status"; ?>
                                </h2>
                            </div>
                            <div>
                                    ...
                                    <select name="worker_assigned" id="worker_assigned">
                                        ...
                                        if ($result2->num_rows > 0) {
                                            while ($row2 = $result2->fetch_assoc()) {
                                                ?>
                                                <option value="<?php echo $row2["username"]; ?>"><?php echo $row2["username"]; ?>
                                                </option>
                                                <?php
                                            }
                                        }
