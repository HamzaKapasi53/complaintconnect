        ...
        <table class="table bg-transparent text-white ">
            ...
            <?php
              ...
              <tr>
                ...
                <td class=" col-2 "><a type="button" class="btn btn-primary" style = "background:#FF9F00 ; border:none; color: var(--font-color);" href="../php/takeAction.php?id=<?php echo $row['complaint_id']; ?>">Take Actions</a></td>
              ...
              <?php
                    ...
                    echo "<td colspan='4'> <p style='color: var(--font-color);'>No complaints found.</p></td>";
                }
