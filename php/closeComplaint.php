...
<div class="content">
    ...
    <h3 style="color:white">Your Reviews : </h3>
        ...
        <div id="notSatisfiedFormContent" style="display: none;display:flex ; flex-direction:column ; gap:2rem;">
            <form id="notSatisfiedForm" action="../php/notSatisfied.php?id=<?php echo $_GET['id']; ?>" style="display:none" method="post">
            <br>
<h1>
<label for="dissatisfaction_cause">Cause for Dissatisfaction:</label>
                ...
                <br>
                <textarea id="dissatisfaction_cause" name="dissatisfaction_cause" style="width:400px;height:150px"></textarea>
                <br>
