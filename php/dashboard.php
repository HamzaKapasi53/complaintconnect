...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Biryani&family=Poppins:wght@400;500&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        * {
        ...
        .content {
            ...
            display: flex;
            margin-left: 80px;
            /* Initial margin-left to match the nav width */
        ...
        .nav:hover .nav-content a,
        .nav:hover .nav-content-down a {
            visibility: visible;
            transition: 0.2s;
        ...
        .nav-content-down div:hover {
            background-color: #FF9F00;

        }

        .nav-content div:hover a,
        .nav-content-down div:hover a,
        .nav-content div:hover i,
        .nav-content-down div:hover i {
            color: white;
        }
...
<body>
    ...
    <div class="nav">
        ...
        <div class="nav-content-down">
            ...
            <div onclick="toggle()" style="display:none">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <div class="box4">
                                ...
                                <div class="left">
                                    <div class="circle"
                                        style="width: 11px; height: 11px; border-radius: 50%; background-color: #FF5858;"></div>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <div class="box4" style="<?php echo $priorityStyle; ?>">
                                ...
                                <div class="left">
                                    <div class="circle"
                                        style="width: 11px; height: 11px; border-radius: 50%; background-color: #F4DD0E;"></div>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <div class="box4" style="margin-left:2rem;">
                                ...
                                <div class="left">
                                    <div class="circle"
                                        style="width: 11px; height: 11px; border-radius: 50%; background-color: #05FF00;"></div>
